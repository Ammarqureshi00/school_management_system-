      ...
      <div class="container-fluid">
            ...
            <ul class="navbar-nav ms-auto">
                  ...
                  <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle mb-4" data-bs-toggle="dropdown">
                              <img src="{{ optional(Auth::user())->profile_pic_url ?? asset('assets/img/default-user.png') }}"
                                    alt="User Image" class="rounded-circle shadow img-fluid"
